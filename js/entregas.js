(function() {
    $.getJSON( "dados/entregas.json", function( dados ) {
        var htmlStr = [];
        $.each( dados, function(e) {
            ...
            item +=             '<a class="social-link rounded-circle " data-toggle="tooltip" data-placement="bottom" title="Download" target="_blank" href="'+ documento.linkDoc +'">';
            item +=                 '<i class="fa fa-download"></i>';
            item +=             '</a>';
            item +=         '</div>'
            item +=     '</div>'    
            item += '</div>';
